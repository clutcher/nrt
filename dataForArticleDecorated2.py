...
def count_parametrs(rc):
    ...
    fc = open('data-flower-new-3/x.txt', 'w')
    for x in xi:
        fc.write(str(x) + '\n')
    fc.close()

    fc = open('data-flower-new-3/etta-razriv.txt', 'w')
    for nyu in nyuAll:
        fc.write(str(nyu) + '\n')
    fc.close()

    fc = open('data-flower-new-3/clustering.txt', 'w')
    for c in cAll:
        fc.write(str(c) + '\n')
    fc.close()
    ...
    fc = open('data-flower-new-3/asortativity.txt', 'w')
